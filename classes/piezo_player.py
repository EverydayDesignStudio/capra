...
# ---------------------------------------------------
# The the main logic for this class was taken from:
# https://github.com/gumslone/raspi_buzzer_player
# 
# It was released to the public allowing anyone to freely copy, modify, 
...
class PiezoPlayer:
    ...
    # Below are examples of how you would play them
    #
    ...
    # Power On
    capra_power_on_melody = [
        notes['F5'],notes['E5'],notes['F5'],notes['E5'],notes['D5']
    ]

    capra_power_on_tempo = [
        16,16,8,8,4
    ]

    # Start
    capra_start_melody = [
        notes['E3'], notes['E3'], notes['E3'],
        notes['E3'], notes['E3'], notes['E3'],
        notes['C3'], notes['D3'], notes['E3']
    ]
    ...
    # Still here
    capra_still_going_melody = [
        notes['D4'], notes['A3']
    ]

    capra_still_going_tempo = [
        8, 4
    ]

    # Stop
    capra_stop_melody = [
        notes['B4'], notes['G4'], notes['E3'], 
        notes['C2'], notes['A2'], notes['C1']
    ]
    ...
    def play_mario(self):
        print("Super Mario Theme")
        self.play(self.melody, self.tempo, 1.3, 0.800)

    def play_crazy_frog(self):
        print("Crazy Frog (Axel F) Theme")
